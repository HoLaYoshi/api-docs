...
6. `POST /api/v2/orders/:market_code `下单

* URL `https://openapi.ocx.com/api/v2/orders/:market_code`

Warning: **URL 和 body 请求参数中均需要传入 market_code**
...
```json
# Request
POST https://openapi.ocx.com/api/v2/orders/:ethbtc
# Response
{
    "data": {
        "id": 3,
